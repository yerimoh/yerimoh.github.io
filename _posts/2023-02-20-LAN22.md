...
of 5e-6, 1e-5, 2e-5, or 5e-5 with a slanted triangular schedule (Howard and Ruder, 2018) which is
...
learning rate of 2e-5. While task-dependent, optimal hyperparameters for eac
