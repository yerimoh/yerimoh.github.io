...
$$
\text{모든 서로 다른 입력이 서로 다른 출력을 만드는 함수}
$$



$$
\text{함수 } T: V \to W \text{ 가 일대일 } \Leftrightarrow
T(\vec{v}_1) = T(\vec{v}_2) \Rightarrow \vec{v}_1 = \vec{v}_2
$$

또는,

$$
T(\vec{v}_1) = T(\vec{v}_2) \text{ 이면 반드시 } \vec{v}_1 = \vec{v}_2
$$
...
$$
\text{모든 출력값에 도달할 수 있는 함수}
$$


$$
T: V \to W \text{ 가 전사 } \Leftrightarrow \forall \vec{w} \in W,\ \exists \vec{v} \in V \text{ such that } T(\vec{v}) = \vec{w}
$$
