...
![image](https://user-images.githubusercontent.com/76824611/224199690-ea8fc98c-c99b-4f4e-96f5-8f43273160e6.png)
    ...
    * **$$y<i$$**: $$y_i$$를 제외한 최대 값의 target subword-tokens       
...
adding MI-based loss. We reinterpret domainspecific knowledge from MI perspective and promote a model to explore domain knowledge by
penalizing low MI. Our results prove that the proposed method is effective in increasing overall MI.
