...
Examples of verifed word analogies corresponding to various materials science concepts. The frst column lists the types of tested analogies. The second column is an example vector operation for
...
score of our model shown in the ffth column. Application analogies were not tested quantitatively and the example is for demonstration purposes only. The full list of tested analogies is available at
