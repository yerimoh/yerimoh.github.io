...
## Word2vec training    
We used the Word2vec implementation in gensim (https://
...
Information section S2 for comparison between models). The vocabulary consisted of all words that occurred more than five times as well as normalized
...
a 10−4
 threshold, which subsamples approximately the 400 most common words.
