...
expensive elements), but others appear to be experimentally testable candidates. An exhaustive manual literature search revealed that, from the frst 150 predictions using the full corpus of collected
...
two years. In the top 50 listed here we have excluded any predictions for which we could fnd thermoelectric reports outside our corpus. 
