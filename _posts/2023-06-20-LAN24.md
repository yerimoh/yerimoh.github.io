...
Projection. In fig. S7a, the 200-dimensional embeddings of the 12,340 materials mentioned more than 10 times in our corpus were reduced to 2 dimensions using t-SNE25, 26
.
...
distance cutoff  = 2.75 and a minimum count of 8, producing well separated clusters.
...
corresponds to a material, with the weights of the edges corresponding to cosine similarities between the materials. We used the default damping value of 0.85 to compute the
...
ZnO, SiO2, Al2O3 and SiC, which are all used for a large spectrum of applications.
