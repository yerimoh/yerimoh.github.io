...
and English Wikipedia, containing a total of 3.3 billion words. SciBERT21, an
LM trained on scientific literature, was pre-trained using a corpus
...
given in our previous work10. For concrete and alloys, we first downloaded
...
whether they were relevant to the field of interest or not. Further, we
finetuned SciBERT classifiers21,55, one for each category of material, on
...
Note that the texts in the scientific literature may have several symbols,
...
a. get rid of random Unicode characters like , , , and
...
from the tokenizers library by Hugging Face56,57. Next, we created a list
