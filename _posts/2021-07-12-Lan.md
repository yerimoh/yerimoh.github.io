...
* 이 벡터들은 **모델이 학습하는 특정한 패턴을 따름**    
  ...
  * 010101(sin,cos) 이렇게 넣어주고 이를 embeding과 더해준다(embeding이 그럼 손상되지 않을까?➡ 그럴 수 있다! 그런데 명확한 설명이 없어 이에 대한 많은 연구가 논의중이다 ex [BERT](https://yerimoh.github.io/Lan2/#position-embedding)같은 경우는 이 부분을 학습 가능하게 하였다.)        
...
<details>
<summary>📜 encoder의 self-attention과 decoder의 Masked self-attention layer 차이점 보기</summary>
<div markdown="1">
...
![image](https://user-images.githubusercontent.com/76824611/132580950-07da4de9-8f00-44f4-bc76-ad559451c2d1.png)
