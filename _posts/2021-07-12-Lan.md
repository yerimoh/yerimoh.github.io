...
* 이 벡터들은 **모델이 학습하는 특정한 패턴을 따름**    
  ...
  * 010101(sin,cos) 이렇게 넣어주고 이를 embeding과 더해준다(embeding이 그럼 손상되지 않을까?➡ 그럴 수 있다! 그런데 명확한 설명이 없어 이에 대한 많은 연구가 논의중이다 ex [BERT](https://yerimoh.github.io/Lan2/#position-embedding))        
