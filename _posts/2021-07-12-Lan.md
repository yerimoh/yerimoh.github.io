...
- [encoder](#encoder)
  ...
  * [self-attention_multi-headed attention](#self-attention-multi-headed-attention)
...
실제로는 벡터단위로 계산을 안하고 **행렬 단위**로 계산을 하지만 이해를 위해 백터계산을 설면 한 후 행렬 계산을 보여주겠다.   
