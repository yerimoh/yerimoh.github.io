...
![image](https://user-images.githubusercontent.com/76824611/131543273-6c5fe52d-5af7-439c-be90-f27f342dfdf6.png)
...
**최근**에는 **ReLU** Rectified Linear Unit, 렐루 함수를 주로 이용   
...
# 출력층 설계
그럼 **활성화 되었다는 전제하**에 이 값을 그냥 그대로 전달을 할까??     
* 계단 함수: **그 a값 자체**를 0또는 1 사이로 변환한다        
* 시그모이드 함수: **그 a값 자체**를 0~1사이로 변환한다       
* ReLU 함수: **그 a값 자체**를 전달한다     

그렇다면 이 a값을 **출력층에서** ~~자체가 아닌~~ **다른노드들과 계산**하여 필요한 값으로 변환하여 출력할 수 있을까?     
