---
title: "[04] Deep learning 1: 신경망 학습 (매개변수 갱신)"
date:   2020-03-10
excerpt: "수치 미분,해석적 미분(analytic), 학습 알고리즘 구현하기/ 경사하강법,plateau, 플래토"
...
매개변수가 갱신되려번 **미분**을 통한 **기울기 산출을 통해** 손실을 최소화 하는 위치로 이동해야한다.   
