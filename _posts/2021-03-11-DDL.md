...
## [15] 순환신경망 RNN   [learn [14]](https://yerimoh.github.io/DL16/){: .btn}    
- [확률과 언어 모델](#확률과 언어 모델)
...
## [16] RNN에 게이트 추가하기(LSTM)  [learn [15]](https://yerimoh.github.io/DL17/){: .btn}
...
## [17] RNN을 사용한 문장 생성   [learn [16]](https://yerimoh.github.io/DL18/){: .btn}
...
# [18] 어텐션 Attention   [learn [17]](https://yerimoh.github.io/DL19/){: .btn}
- [INTRO](#intro)
- [어텐션의 구조](#어텐션의-구조)
...
## Deep learning: Hyperparameter와 Parameters  [learn](https://yerimoh.github.io/DL100/){: .btn}  

## Deep learning: Training, validation, test datasets 비교 [learn](https://yerimoh.github.io/DL101/){: .btn}    

## Deep learning: 오토인코더(Auto Encoder) [learn](https://yerimoh.github.io/DL104/){: .btn}      

## 강화학습 (Reinforcement Learning) [learn](https://yerimoh.github.io/DL105/){: .btn} 

## Deep learning: NeMo를 통한 BERT 구현, 코드 설명 [learn](https://yerimoh.github.io/DL107/){: .btn}    

## Deep learning: Transformer 구현, 코드 설명  [learn](https://yerimoh.github.io/DL106/){: .btn}    

## Deep learning: 프레임워크, 라이브러리  [learn](https://yerimoh.github.io/DL108/){: .btn}    
