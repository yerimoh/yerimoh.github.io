...
먼저 미분($$ \frac{∂}{∂v_c} $$)하고,       
![image](https://user-images.githubusercontent.com/76824611/178574133-afad093b-3ba3-44a2-a143-5bbd68027f2f.png)

$$log$$ $$ \frac{a}{b} $$ $$= a-b$$이므로   
![image](https://user-images.githubusercontent.com/76824611/178575451-f7a04f95-684e-49f6-9aa2-5b25200334c4.png)

그럼 각 식을 <span style="colcr: #000FF">①</span>과 로 보고 계산해보자     
* <span style="colcr: #000FF">① 식</span>      

* <span style="colcr: #ffd33d">② 식</span>      
