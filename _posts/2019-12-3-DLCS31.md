...
위에서 본 목적함수(loss function) $$J(θ)$$의 미분값, 즉 $$J'(θ)$$를 **최대화(maximize)** 하는 것이 목표거나,      
![image](https://user-images.githubusercontent.com/76824611/178568193-209b6cbc-8d6e-42ce-a6a7-dc068ce7304e.png)
