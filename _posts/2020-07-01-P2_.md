...
<br>1.리스트에 요소 추가
  <br>리스트 이름.append(추가할 것) 
<br>리스트의 맨 마지막에 추가, 어떤 자료형도 가능

2.리스트 정렬 
 <br>리스트 이름.sort() /숫자 알파벳 가능
{% highlight css %}
>>> a = [1, 4, 3, 2]
>>> a.sort(  )
>>> a
...
8.리스트 속의 개수 세기
 <br>리스트 이름.count(세고 싶은 요소)
 
9.리스트 확장
 <br>리스트 이름.extend() / 뒤에 추가
