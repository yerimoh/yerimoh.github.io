...
date:   2020-03-3
excerpt: "문제와 예씨로 쉽게 배우는 Fundamentals of Hypothesis Testing: One-Sample Tests, The Null Hypothesis, $$H_0$$,The Alternative Hypothesis, $$H_1$$,The Hypothesis Testing Process,Critical Value approach,p-Value approach,Risks in Decision Making Using Hypothesis Testing"
