...
entire entity database of 3.27 million documents is available
online for bulk download in JSON format.22
...
perform NER on any desired materials science text. Finally, we
have developed a web application, http://matscholar.com, for
