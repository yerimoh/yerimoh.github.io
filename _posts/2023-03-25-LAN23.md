...
전체 정보 추출 파이프라인은 그림 1에 나와 있습니다. 파이프라인의 각 단계에 대한 자세한 정보는 추출된 결과 분석과 함께 아래에 나와 있습니다. 아래에 설명된 기계 학습 모델은 Scikit-learn, 23 Tensorflow, 24 및 Keras25 파이썬 라이브러리를 사용하여 훈련됩니다
