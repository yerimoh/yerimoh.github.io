...
date:   2020-02-22
excerpt: "기울기 클리핑 gradients clipping/ 기본적인 RNN의 문제점/기울기 소실 또는 기울기 폭발 ,기울기 소실과 LSTM,output 게이트,forget 게이트,새로운 기억 셀,input 게이트/LSTM의 기울기 흐름, 구현/기울기 클리핑/RNNLM 추가 개선/매개변수 갱신"
...
- [RNNLM 추가 개선](#rnnlm-추가 개선)
    ...
    + [드롭아웃에 의한 과적합 억제](#---------------)
    + [가중치 공유 weight tying](#-------weight-tying)
  * [개선된 RNNLM 구현](#----rnnlm---)
- [정리](#--)
