...
# 목차   
- [오차역전법(backpropagation)(=‘역전파법’,‘역전파’)](#------backpropagation----------------)
- [계산그래프 computational graph](#------computational-graph)
  * [계산그래프로 풀기](#---------)
  * [국소적 계산](#------)
  * [연쇄법칙 chain rule](#-----chain-rule)
  * [역전파](#---)
    + [덧셈 노드의 역전파](#----------)
    + [곱셈 노드의 역전파](#----------)
  * [코드 구현](#-----)
...
- [활성화 함수 계층 구현](#------------)
  ...
  * [Sigmoid 계층](#sigmoid---)
    + [역전파](#----2)
    + [구현](#---1)
- [Affine/Softmax 계층 구현하기](#affine-softmax--------)
  * [Affine 계층](#affine---)
    + [역전파](#----3)
    + [배치용 Affine 계층](#----affine---)
  * [Softmax-with-Loss 계층](#softmax-with-loss---)
    + [구현](#---2)
- [오차역전파법 구현](#---------)
  * [인스턴스 변수](#-------)
  * [메서드  설명](#-------)
