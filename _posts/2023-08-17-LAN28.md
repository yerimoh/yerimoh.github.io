...
금 나노 입자(AuNP)는 생체 의학(예: 체외 진단), 반도체 기술 및 화장품에 널리 사용됩니다. 72–76 크기와 모양에 대한 AuNP 특성의 강한 의존에도 불구하고, 합성 방법은 최근에서야 AuNP 형태론, 특히 이방성 나노 로드를 제어할 수 있었습니다. 이 데이터 세트는 AuNP 합성 문헌의 전문의 관련 섹션에서 AuNP 형태론과 설명을 캡처하는 것을 목표로 합니다. 단일 주석자는 AuNP 합성에 대한 73개의 기사에서 85개의 특성화 단락 세트에 주석을 달았습니다
